...
type BlockSenders interface {
	...
	BlockSenderByID(id string) (*mDBApp.BlockSender, error)
	BlockSenderByAddress(address string) (*mDBApp.BlockSender, error)
	BlockSenderByPublicKey(publicKey string) (*mDBApp.BlockSender, error)
}
...
type BlockAccounts interface {
	...
	BlockAccountBySender(publicKey *intMaxAcc.PublicKey) (*mDBApp.BlockAccount, error)
	BlockAccountByAccountID(accountID *uint256.Int) (*mDBApp.BlockAccount, error)
